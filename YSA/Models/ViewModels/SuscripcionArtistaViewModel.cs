// YSA.Web.Models.ViewModels/SuscripcionArtistaViewModel.cs
namespace YSA.Web.Models.ViewModels
{
    public class SuscripcionArtistaViewModel
    {
        ...
        public bool PuedeRenovar => Estado == "Activa" || Estado == "Vencida";
        public bool EstaPorVencer => Estado == "Activa" && FechaFin <= DateTime.UtcNow.AddDays(7);
        public string DiasRestantes => Estado == "Activa" ? Math.Max(0, (int)(FechaFin - DateTime.UtcNow).TotalDays).ToString() : "0";
    }

    // ViewModel para aprobar/rechazar
    public class ValidarSuscripcionViewModel
    {
        public int Id { get; set; }
