...
namespace YSA.Data.Migrations
{
    ...
    [Migration("20260404165358_CursosPresenciales")]
    partial class CursosPresenciales
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YSA.Core.Entities.ClasePresencial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NotasInstructor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ClasesPresenciales", (string)null);
                });
            ...
            modelBuilder.Entity("YSA.Core.Entities.InscripcionClase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ClasePresencialId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClasePresencialId");

                    b.HasIndex("EstadoAsistencia");

                    b.HasIndex("EstudianteId");

                    b.HasIndex("ClasePresencialId", "EstudianteId")
                        .IsUnique();

                    b.ToTable("InscripcionesClases", (string)null);
                });
            ...
            modelBuilder.Entity("YSA.Core.Entities.Usuario", b =>
                {
                    ...
                    b.Property<string>("ExperienciaTatuaje")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("YSA.Core.Entities.InscripcionClase", b =>
                {
                    b.HasOne("YSA.Core.Entities.ClasePresencial", "ClasePresencial")
                        .WithMany("Inscripciones")
                        .HasForeignKey("ClasePresencialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YSA.Core.Entities.Usuario", "Estudiante")
                        .WithMany("InscripcionesClases")
                        .HasForeignKey("EstudianteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ClasePresencial");
            ...
            modelBuilder.Entity("YSA.Core.Entities.Curso", b =>
                {
                    ...
                    b.Navigation("ClasesPresenciales");
            ...
            modelBuilder.Entity("YSA.Core.Entities.Usuario", b =>
                {
                    ...
                    b.Navigation("InscripcionesClases");
