...
namespace YSA.Data.Migrations
{
    ...
    [Migration("20260403153252_PlanesSuscripciones")]
    partial class PlanesSuscripciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YSA.Core.Entities.Articulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BiografiaCortaDestacado")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NombrePersonaDestacada")
                        .IsRequired()
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("UrlFotoDestacado")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("YSA.Core.Entities.ArticuloFoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YSA.Core.Entities.CursoInstructor", b =>
                {
                    b.Property<int>("CursoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YSA.Core.Entities.EntregaActividad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ObservacionInstructor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RecursoActividadId")
                        .HasColumnType("int");

                    b.Property<string>("UrlArchivoEntrega")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("RecursoActividadId");

                    b.ToTable("EntregasActividades");
                });
            ...
            modelBuilder.Entity("YSA.Core.Entities.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YSA.Core.Entities.PlanSuscripcion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("DescuentoComisionAdicional")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.Property<int>("LimitePublicaciones")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<int>("MaxPromocionesSimultaneas")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
                    ...
                    b.Property<bool>("PermitePromocionesExtras")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("TieneVisibilidadPrioritaria")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("YSA.Core.Entities.RecursoActividad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("RequiereEntrega")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("YSA.Core.Entities.SuscripcionArtista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PublicacionesUsadas")
                        .HasColumnType("int");

                    b.Property<decimal>("SnapshotComisionPorcentaje")
                        .HasColumnType("decimal(5,2)");

                    b.Property<int>("SnapshotDuracionDias")
                        .HasColumnType("int");

                    b.Property<int>("SnapshotLimitePublicaciones")
                        .HasColumnType("int");

                    b.Property<string>("SnapshotNombre")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<bool>("SnapshotTieneVisibilidadPrioritaria")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SuscripcionesArtistas");
                });

            modelBuilder.Entity("YSA.Core.Entities.TasaBCV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YSA.Core.Entities.TipoNotificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YSA.Core.Entities.ArticuloFoto", b =>
                {
                    b.HasOne("YSA.Core.Entities.Articulo", "Articulo")
                        .WithMany("Fotos")
            ...
            modelBuilder.Entity("YSA.Core.Entities.Artista", b =>
                {
                    b.HasOne("YSA.Core.Entities.Usuario", "AprobadoPor")
                        .WithMany("ArtistasAprobados")
            ...
            modelBuilder.Entity("YSA.Core.Entities.EntregaActividad", b =>
                {
                    ...
                    b.HasOne("YSA.Core.Entities.RecursoActividad", "RecursoActividad")
                        .WithMany("Entregas")
                        .HasForeignKey("RecursoActividadId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("YSA.Core.Entities.Notificacion", b =>
                {
                    b.HasOne("YSA.Core.Entities.TipoNotificacion", "TipoNotificacion")
            ...
            modelBuilder.Entity("YSA.Core.Entities.PlanSuscripcion", b =>
                {
                    b.HasOne("YSA.Core.Entities.Usuario", "ModificadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("YSA.Core.Entities.SuscripcionArtista", b =>
                {
                    ...
                    b.HasOne("YSA.Core.Entities.PlanSuscripcion", "Plan")
                        .WithMany("Suscripciones")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YSA.Core.Entities.Usuario", "ValidadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("YSA.Core.Entities.Usuario", b =>
                {
                    ...
                    b.Navigation("ArtistasAprobados");
